...
public class CrearCertificado extends JFrame implements ActionListener{
	...
	public CrearCertificado(File keystore){
		...
		gbc.gridy = 2;
		jp3.add(O);
		O.setToolTipText("Nombre de la Organización del Titular del certificado");
		...
		gbc.gridy = 5;
		jp6.add(C);
		C.setToolTipText("País (2 letras) del Titular del certificado");
		...
		gbc.gridy = 11;
		jp12.add(keypass);
		keypass.setToolTipText("Contraseña para el certificado (Obligatorio)");
